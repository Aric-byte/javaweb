...
<%@ page import="com.hx.util.CaptchaUtil" %>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .captcha-group { background: #f9f9f9; padding: 15px; border-radius: 5px; margin-bottom: 25px; }
        .captcha-question { font-size: 18px; font-weight: bold; color: #333; margin-bottom: 10px; text-align: center; }
        .captcha-input { width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 5px; font-size: 14px; text-align: center; }
    </style>
</head>
<body>
    <div class="login-container">
        ...
        <form action="<%= request.getContextPath() %>/login" method="post" autocomplete="off">
            ...
            <div class="captcha-group">
                ...
                <input type="text" name="captchaAnswer" class="captcha-input" required placeholder="请输入答案" autocomplete="off">
            </div>
